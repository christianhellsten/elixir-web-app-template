...
require.register("web/js/app", function(exports, require, module) {
'use strict';
...
require.register("web/js/firebugx", function(exports, require, module) {
var nada, names;
...
try {
  ...
  nada = function() {
    ...
    for (i = 0, len = names.length; i < len; i++) {
      name = names[i];
      results.push(window.console[name] = window.console[name] || nada);
    }
    return results;
  };
} catch (undefined) {}
...
;require.register("web/js/flash", function(exports, require, module) {
var Flash;
  ...
  Flash.prototype.show = function() {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (value) {
        ...
        $(this.flash_holder).append("<span class=\"flash_" + key + "\">" + value + "</span>").show();
        results.push($.removeCookie(name, {
          path: '/'
        }));
      } else {
        results.push(void 0);
